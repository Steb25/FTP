...
logging.basicConfig(filename="/home/pi/WebServer/ftp/log/{}.log".format(str(datetime.datetime.now())), level=logging.INFO)
...
class Authorizer(DummyAuthorizer):
    ...
    def get_home_dir(self, username):
        ...
        directories = ["/home/pi/WebServer/html/{}/".format(folder_name), "/home/pi/WebServer/html/{}".format(folder_name)]
    ...
    def validate_user(self, username, password):
        logg("Someone is connecting with {} usn".format(username))
        try:
            with open('/home/pi/WebServer/ftp/users/users.json', 'r') as json_file:
